...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 25 18:15:01 2019

@author: ssli

Using TreeCorr to calculate the 2-point shear correlation function
e is NOT modified by weighted e from 2e_vs_ZB.py
"""
...
if __name__ == "__main__":
    ...
    # output path 
    outpathF = "/disks/shear15/ssli/KV450/CS/mine/TreeCorr/full/pre/withoutc/"
    outpathP = ".dat"
    ...
    for i in range(len(inpathL)):
        ...
        e1_corr = data["bias_corrected_e1"]
        e2_corr = data["bias_corrected_e2"]
